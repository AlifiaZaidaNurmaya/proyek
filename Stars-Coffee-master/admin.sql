...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Okt 2020 pada 12.32
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
('admin', '5910e0e2e6915189b630bccfd1fd09b8', 'admi@gmail.com', 'adminkopi', 'admin'),
...
ALTER TABLE `detail_transaksi`
 ADD KEY `id_transaksi` (`id_transaksi`), ADD KEY `id_produk` (`id_produk`);
...
ALTER TABLE `keranjang`
 ADD KEY `username` (`username`), ADD KEY `id_produk` (`id_produk`);
...
ALTER TABLE `pengiriman`
 ADD PRIMARY KEY (`id_kirim`), ADD KEY `id_transaksi` (`id_transaksi`);
...
ALTER TABLE `transaksi`
 ADD PRIMARY KEY (`id_transaksi`), ADD KEY `username` (`username`);
