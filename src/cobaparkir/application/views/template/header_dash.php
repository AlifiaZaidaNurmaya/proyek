    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Brand Logo -->
                <a href="<?php base_url()?>home" class="brand-link">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="info">
                            <a href="#" class="d-block"><?=$this->session->userdata('nama');
?></a>
               ...
               <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?=base_url();?>petugas" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="<?=base_url();?>superadmin" class="nav-link">
                                            <i class="nav-icon fas fa-users"></i>
                                            <p>
                                                Tabel Admin
                                            </p>
                            ...
                            <li class="nav-item">
                                <a href="<?=base_url();?>entry" class="nav-link">
                                    <i class="nav-icon fas fa-columns"></i>
                                    <p>
                                        Tabel Entry
                                    </p>
