...
public class DBContract {
    ...
    public static final String SERVER_DELETE_BOOKING_URL = "http://192.168.1.2/cobaparkir/api/Booking_Api/delete";
    public static final String SERVER_UPDATE_PARKIR_BOOKING_URL = "http://192.168.1.2/cobaparkir/api/Booking_Api/changestatus";
    public static final String SERVER_CEK_ENTRY_URL = "http://192.168.1.2/cobaparkir/api/Entry_Api/cekentry";
    public static final String SERVER_CEK_ENTRY_PELANGGAN_URL = "http://192.168.1.2/cobaparkir/api/Entry_Api/cekentrypelanggan";
    public static final String SERVER_CEK_BOOKING_PELANGGAN_URL = "http://192.168.1.2/cobaparkir/api/Booking_Api/cekbookingpelanggan";
    public static final String SERVER_INPUT_NO_BOOKING_ENTRY_URL = "http://192.168.1.2/cobaparkir/api/Entry_Api/entrynobooking";
    public static final String SERVER_INPUT_BOOKING_ENTRY_URL = "http://192.168.1.2/cobaparkir/api/Entry_Api/entrybooking";
    public static final String SERVER_CHECKOUT_ENTRY_URL = "http://192.168.1.2/cobaparkir/api/Entry_Api/checkout";
    public static final String SERVER_INPUT_TRANSAKSI_URL = "http://192.168.1.2/cobaparkir/api/Transaksi_Api/inputtransaksi";
}
